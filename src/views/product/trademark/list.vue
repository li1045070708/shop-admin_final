<template>
  <div>
    <el-button type="primary" icon="el-icon-plus" @click="showAdd" v-if="$hasBP('trademark.add')">添加</el-button>
      ...
      <el-table-column label="操作">
        <template slot-scope="{row, $index}">
          <el-button type="warning" size="mini" icon="el-icon-edit" @click="showUpdate(row)"
            v-if="$hasBP('trademark.update')">修改</el-button>
          <el-button type="danger" size="mini" icon="el-icon-delete" @click="remove(row)"
            v-if="$hasBP('trademark.delete')">删除</el-button>
        </template>
      </el-table-column>
    </el-table>
